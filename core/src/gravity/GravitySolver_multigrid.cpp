...
void GravitySolver_multigrid::gauss_seidel_intermediate_amr_correction(const Array_t& Uintermediate, const uint32_t level, const Function& is_coloured) {
  const ForeachCell& foreach_cell = pdata->foreach_cell;
  const ForeachCell::CellMetaData& cells = foreach_cell.getCellMetaData();
  const Kokkos::Array<BoundaryConditionType, 3>& boundarycondition = pdata->boundarycondition;
...
*/
template< typename Array_t, typename Function >
void GravitySolver_multigrid::gauss_seidel_leaves_amr_finest(const Array_t& U, const Array_t& Uintermediate, const uint32_t level, const Function& is_coloured) {
  const ForeachCell& foreach_cell = pdata->foreach_cell;
  const ForeachCell::CellMetaData& cells = foreach_cell.getCellMetaData();
  const Kokkos::Array<BoundaryConditionType, 3>& boundarycondition = pdata->boundarycondition;
...
*/
template< typename Array_t, typename Function >
void GravitySolver_multigrid::gauss_seidel_leaves_uniform(const Array_t& U, const Array_t& Uintermediate, const uint32_t level, const Function& is_coloured) {
  const ForeachCell& foreach_cell = pdata->foreach_cell;
  const ForeachCell::CellMetaData& cells = foreach_cell.getCellMetaData();
  const Kokkos::Array<BoundaryConditionType, 3>& boundarycondition = pdata->boundarycondition;
...
*/
template< typename Array_t, typename Function >
void GravitySolver_multigrid::gauss_seidel_intermediate(const Array_t& U, const Array_t& Uintermediate, const uint32_t level, const Function& is_coloured) {
  const ForeachCell& foreach_cell = pdata->foreach_cell;
  const ForeachCell::CellMetaData& cells = foreach_cell.getCellMetaData();
  const Kokkos::Array<BoundaryConditionType, 3>& boundarycondition = pdata->boundarycondition;
