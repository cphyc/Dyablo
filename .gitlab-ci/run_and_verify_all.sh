...
run_and_verify tiling.ini "../../../settings/cosmo/validate_tiling.py tiling_main.xmf 1e-6 ../../../tiling/tiling.png" tiling 
...
run_and_verify stromgren_cosmo.ini "validate_stromgren.py stromgren_main.xmf 0.1 ../../../strom_cosmo/stromgren.png" strom_cosmo
