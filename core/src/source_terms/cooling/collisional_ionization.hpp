...
inline void init_collisional_ionization(TabulatedData& tabData) {
    ...
    copy_data_1D(K_carbon, tabData.K_carbon);
    copy_data_1D(P_carbon, tabData.P_carbon);
    ...
    copy_data_1D(dE_oxygen, tabData.dE_oxygen);
    copy_data_1D(A_oxygen, tabData.A_oxygen);
    copy_data_1D(X_oxygen, tabData.X_oxygen);
    copy_data_1D(K_oxygen, tabData.K_oxygen);
    copy_data_1D(P_oxygen, tabData.P_oxygen);
    ...
    copy_data_1D(dE_nitrogen, tabData.dE_nitrogen);
    copy_data_1D(A_nitrogen, tabData.A_nitrogen);
    copy_data_1D(X_nitrogen, tabData.X_nitrogen);
    copy_data_1D(K_nitrogen, tabData.K_nitrogen);
    copy_data_1D(P_nitrogen, tabData.P_nitrogen);
    ...
    copy_data_1D(dE_neon, tabData.dE_neon);
    copy_data_1D(A_neon, tabData.A_neon);
    copy_data_1D(X_neon, tabData.X_neon);
    copy_data_1D(K_neon, tabData.K_neon);
    copy_data_1D(P_neon, tabData.P_neon);
    ...
    copy_data_1D(dE_magnesium, tabData.dE_magnesium);
    copy_data_1D(A_magnesium, tabData.A_magnesium);
    copy_data_1D(X_magnesium, tabData.X_magnesium);
    copy_data_1D(K_magnesium, tabData.K_magnesium);
    copy_data_1D(P_magnesium, tabData.P_magnesium);
    ...
    copy_data_1D(dE_silicon, tabData.dE_silicon);
    copy_data_1D(A_silicon, tabData.A_silicon);
    copy_data_1D(X_silicon, tabData.X_silicon);
    copy_data_1D(K_silicon, tabData.K_silicon);
    copy_data_1D(P_silicon, tabData.P_silicon);
    ...
    copy_data_1D(dE_sulfur, tabData.dE_sulfur);
    copy_data_1D(A_sulfur, tabData.A_sulfur);
    copy_data_1D(X_sulfur, tabData.X_sulfur);
    copy_data_1D(K_sulfur, tabData.K_sulfur);
    copy_data_1D(P_sulfur, tabData.P_sulfur);
    ...
    copy_data_1D(dE_iron, tabData.dE_iron);
    copy_data_1D(A_iron, tabData.A_iron);
    copy_data_1D(X_iron, tabData.X_iron);
    copy_data_1D(K_iron, tabData.K_iron);
    copy_data_1D(P_iron, tabData.P_iron);
};
